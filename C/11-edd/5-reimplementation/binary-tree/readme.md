...
Consiste en un arbol binario en donde dependiendo del valor de los nodos, se ubican en los subarboles izquierdos o derechos.

## Compilación

Para poder usarse, se debe utilizar compilacion separada. Para ello, se debe incluir el header del TDA de árbol bionario en tu codigo principal:
