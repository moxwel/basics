...
A very simple yet powerful code editor. Able to install extensions to extend use and capabilities. You can turn this code editor to an entire IDE ([Integrated Development Environment](https://en.wikipedia.org/wiki/Integrated\_development\_environment)).
